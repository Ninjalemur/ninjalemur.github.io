...
- **Handle dynamic costs over time (kids, college, caring for elderly)**: I haven't found a way to implement these in spreadsheets in a way that is not too onerous or complex for users.
...
- Consider trying [UP](https://www.upplan.sg/)
    ...
    - It's much more feature rich than my spreadsheet, and can handle many more things such as house and car loans, and various one-time and continuous expenses AND incomes.
